% ==============================================================================
% AGRICULTURAL DATA PLATFORM - FINAL YEAR PROJECT THESIS
...
{\fontsize{14}{17}\selectfont\bfseries Agricultural Data Platform}\\[2cm]
\begin{tabular}{lc}
 & \\
...
We, the undersigned, hereby declare that the project work entitled ``Agricultural Data Platform'' is our original work and has been carried out in partial fulfillment of the requirements for the Bachelor of Science Degree in Computer Engineering at Addis Ababa Science and Technology University.
...
ADP   & Agricultural Data Platform \\
JWT    & JSON Web Token \\

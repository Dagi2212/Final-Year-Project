% ==============================================================================
% AGRICULTURAL PRODUCT DATA PLATFORM - FINAL YEAR PROJECT THESIS
...
\definecolor{headerblue}{RGB}{24, 95, 165}
...
@article{vanklinken2022,
  ...
  title = {agricultural product data systems in sub-Saharan Africa: A review},
...
\begin{center}
\vspace*{1cm}
\includegraphics[width=3.5cm]{aastu-logo.png}\\[1cm]
{\fontsize{16}{19}\selectfont\bfseries ADDIS ABABA SCIENCE AND TECHNOLOGY UNIVERSITY}\\[0.8cm]
{\large\bfseries College of Engineering}\\[0.4cm]
{\large\bfseries Department of Electrical and Computer Engineering}\\[1.2cm]
{\large\bfseries Final Year Project on}\\[0.6cm]
{\fontsize{18}{17}\selectfont\bfseries Agricultural Product Data Platform}\\[2cm]
\begin{tabular}{lc}
 & \\
\textbf{Name} & \multicolumn{1}{r}{\textbf{ID}} \\
 & \\
1. Kidan Dibekulu  & \multicolumn{1}{r}{ETS0916/14} \\
2. Kaleab Kebede   & \multicolumn{1}{r}{ETS0857/14} \\
3. Kalkidan Yishak & \multicolumn{1}{r}{ETS0888/14} \\
4. Dagmawi Shewaye & \multicolumn{1}{r}{ETS0425/14} \\
\end{tabular}

\vfill

{\normalsize\textit{Submitted to Addis Ababa Science and Technology University for the award of Bachelor of Science Degree in Electrical and Computer Engineering (Computer Engineering)}}
\end{center}
\end{titlepage}
...
We, the undersigned, hereby declare that the project work entitled ``Agricultural Product Data Platform'' is our original work and has been carried out in partial fulfillment of the requirements for the Bachelor of Science Degree in Computer Engineering at Addis Ababa Science and Technology University.
...
\vspace{0.4cm}
\begin{tabular}{lll}
\textbf{Name} & \textbf{Date} & \textbf{Signature} \\[0.3cm]
Instructor Esubalew M. & \rule{3cm}{0.4pt} & \rule{5cm}{0.4pt} \\
\end{tabular}
% ==============================================================================
% ACKNOWLEDGEMENT
% ==============================================================================
...
ADP   & agricultural product data Platform \\
JWT    & JSON Web Token \\
...
agricultural product data systems are technologies and processes for capturing, storing, analyzing, and disseminating farming-related information to enhance decision-making and food security. Traditional paper-based data collection is time-consuming, error-prone, and difficult to scale, particularly in developing regions \cite{vanklinken2022}. Automated and technology-driven solutions are therefore essential for modernizing agricultural product data management.

Ethiopian agriculture employs over 80 percent of the population and contributes approximately 33 percent of national GDP, yet it faces severe challenges including yield uncertainty, resource misallocation, poor rural connectivity, and fragmented record-keeping. Internet penetration remains below 20 percent nationally \cite{worldbank2022}, and data fragmentation across government ministries, NGOs, cooperatives, and research institutions prevents the formation of a coherent national picture of agricultural production.

Recent advances in machine learning offer viable alternatives to manual systems. Gradient boosting algorithms have demonstrated strong performance for tabular agricultural product data , achieving high accuracy in yield prediction across multiple crop types and regions \cite{patel2020}. The Gradient Boosting Regressor handles non-linear relationships and mixed feature types effectively on moderate-sized datasets, making it well-suited for developing-country agricultural applications without requiring specialized hardware \cite{scikit2024}.

The agricultural product data Platform addresses these challenges through an integrated combination of offline synchronization for low-connectivity environments, machine learning-powered yield prediction, natural language querying via retrieval-augmented generation, and stakeholder-specific dashboards. The system is built on a full-stack JavaScript architecture (AdonisJS backend, Next.js frontend) with a Python FastAPI microservice for ML inference, and directly supports the Digital Ethiopia 2025 strategy \cite{digitalethiopia2025}.

The key stakeholders in the Ethiopian agricultural product data ecosystem include smallholder farmers who produce the majority of agricultural output but have limited access to digital tools, field agents and extension workers who serve as the primary data collectors in rural areas, agricultural cooperatives that aggregate and market produce from their members, government ministries and regional bureaus that require aggregate statistics for policy planning, NGOs and development organizations that implement agricultural programs and need monitoring data, researchers and academics who analyze agricultural trends and publish findings, and commercial traders and wholesalers who need supply forecasts for market planning.
...
\begin{enumerate}
  ...
  \item To design and develop a Retrieval-Augmented Generation system using large language models (Anthropic Claude, Cerebras, or OpenRouter with automatic fallback) for natural language querying of agricultural product data sets, providing grounded answers with citations to specific database records.
...
\subsection{Scope}
This project focuses on the development of the agricultural product data Platform using modern web architecture, machine learning, and natural language processing. The system is designed to handle agricultural product data including farmer profiles, field information, crop types, yield estimates, and field observations. The project involves collecting and simulating agricultural product data representative of Ethiopian farming conditions. The training dataset comprises 2,000 records spanning 2015 to 2024 across six Ethiopian regions (Afar, Amhara, Oromia, Sidama, SNNPR, Tigray) and eight crop types (teff, wheat, maize, barley, sorghum, sesame, chickpea, coffee) across two growing seasons (Meher and Belg). The system implements a server-side synchronization queue for offline data handling with five status levels and provides role-based access control across seven user roles. The complete backend consists of 108 RESTful API endpoints across 16 controllers, and the database comprises 15 tables across five domains.
...
\toprule
\rowcolor{headerblue}
\textcolor{white}{\textbf{Component}} & \textcolor{white}{\textbf{Scope}} \\
\midrule
...
This study holds great significance in the field of digital agriculture and agricultural product data management. By developing the agricultural product data Platform powered by offline synchronization architecture, machine learning, and natural language processing, this project offers an affordable, scalable, and user-friendly solution to a widespread problem. The system empowers extension workers, cooperatives, and policymakers to access and analyze agricultural product data quickly and accurately using just a mobile device or web browser.
...
agricultural product data systems refer to the integrated collection of technologies, processes, and methodologies used to capture, store, analyze, and disseminate agricultural information to support decision-making by farmers, extension workers, policymakers, and other stakeholders. The fundamental premise underlying agricultural product data systems is that timely, accurate, and accessible information enables better resource allocation, early intervention against crop threats, and improved market efficiency \cite{fao2023}. Van Klinken and colleagues provide a comprehensive review of agricultural product data systems across sub-Saharan Africa, noting that the majority of systems in the region face common challenges including limited connectivity, lack of interoperability, and insufficient analytical capacity \cite{vanklinken2022}. Their review of 47 agricultural product data initiatives across 22 African countries found that fewer than 20 percent of systems had achieved sustained deployment beyond the pilot phase, with the most common failure factors being unreliable connectivity, lack of user training, and insufficient integration with existing workflows.

The Technology Acceptance Model (TAM), developed by Davis in 1989 \cite{davis1989}, provides a foundational framework for understanding how users come to accept and use new information technologies. According to this model, two primary constructs determine technology acceptance: perceived usefulness, defined as the degree to which a user believes that using the system will enhance their job performance, and perceived ease of use, defined as the degree to which a user believes that using the system will be free of effort. In the context of agricultural product data systems in developing countries, TAM is particularly relevant because extension workers and field agents may have limited experience with digital tools, making ease of use a critical factor for adoption. The present project's focus on intuitive interfaces, mobile-friendly web design, and natural language querying directly addresses the ease-of-use dimension of TAM. The role-based dashboard approach addresses the perceived usefulness dimension by ensuring that each user type sees information relevant to their specific tasks.
...
The current state of knowledge indicates that while individual technologies for offline data collection, machine learning-based yield prediction, and natural language querying have been demonstrated in isolation, their integration into comprehensive agricultural product data platforms for developing country contexts remains an open challenge. Most existing solutions address only one or two of these dimensions, and few systems provide the integrated combination of offline sync, ML analytics, RAG querying, and role-based dashboards that this project implements.
...
The present project extends the work of Islam et al.\ by implementing a queue-and-check synchronization engine tailored for agricultural product data with entity-level conflict resolution. The sync queue in the present system tracks operations at the individual entity level with five status states (pending, processing, completed, failed, conflict), supports batch submission for efficiency, and includes comprehensive metadata including device identifier, user identifier, batch identifier, entity type, operation type, payload, client timestamp, retry count, and error message.
...
\toprule
\rowcolor{headerblue}
\textcolor{white}{\textbf{Feature}} & \textcolor{white}{\textbf{DHIS2}} & \textcolor{white}{\textbf{OpenMRS}} & \textcolor{white}{\textbf{Islam et al.}} & \textcolor{white}{\textbf{ADP}} \\
\midrule
...
\subsection{agricultural product data Interoperability Standards}
Interoperability is a critical concern for agricultural product data systems, particularly in contexts where multiple stakeholders collect and use data. The International Organization for Standardization has developed standards for agricultural product data exchange, including ISO 11783 (ISOBUS) for agricultural machinery data and ISO 19156 for geographic information. However, these standards are designed for precision agriculture in industrialized settings and have limited applicability in smallholder farming contexts.

The lack of standardized data formats in Ethiopian agriculture means that any integrated system must be capable of handling diverse data representations. The import module in this project addresses this challenge through its alias-based schema detection, which maps the varied column naming conventions found in real-world agricultural spreadsheets to a unified canonical schema. This approach provides practical interoperability without requiring all data producers to adopt a common format, which would be unrealistic given the fragmented nature of agricultural product data collection in Ethiopia.
...
\begin{description}
  ...
  \item[Gap 2: RAG-Based Querying of Structured agricultural product data .] Existing agricultural question-answering systems operate on static knowledge bases or unstructured text. This study implements a RAG system that queries live structured data from a relational database via automatically generated SQL queries, enabling dynamic, grounded responses.
  ...
  \item[Gap 4: Comprehensive Data Governance in Agricultural Platforms.] Most agricultural product data platforms lack systematic audit logging and data provenance tracking. This study implements comprehensive audit tracking for all CRUD operations across all entities, with record-level traceability.
...
\toprule
\rowcolor{headerblue}
\textcolor{white}{\textbf{Feature}} & \textcolor{white}{\textbf{Type}} & \textcolor{white}{\textbf{Description}} \\
\midrule
...
\toprule
\rowcolor{headerblue}
\textcolor{white}{\textbf{Feature}} & \textcolor{white}{\textbf{Mean}} & \textcolor{white}{\textbf{Std Dev}} & \textcolor{white}{\textbf{Range}} \\
\midrule
...
\begin{tikzpicture}[node distance=1.8cm]
  ...
  \draw[arrow] (retrain.west) -- ++(-1.5,0) |- (preproc.east);
\end{tikzpicture}
...
\begin{tikzpicture}[node distance=1.5cm]
  ...
  % RBAC -> PostgreSQL: exit left, enter left (same side, opposite direction)
  \draw[arrow] (auth.west) -- ++(-1.5,0) |- (pgsql.west);

  % PostgreSQL -> RBAC: exit right, enter right
...
\toprule
\rowcolor{headerblue}
\textcolor{white}{\textbf{Module}} & \textcolor{white}{\textbf{Admin}} & \textcolor{white}{\textbf{Super.}} & \textcolor{white}{\textbf{Field Ag.}} & \textcolor{white}{\textbf{Gov}} & \textcolor{white}{\textbf{NGO}} & \textcolor{white}{\textbf{Trader}} & \textcolor{white}{\textbf{Res.}} \\
\midrule
...
\begin{tikzpicture}[node distance=1.8cm]
  ...
  \draw[arrow] (conflict.east) -- ++(1.5,0) |- (apply.west);
...
The RAG (Retrieval-Augmented Generation) system enables natural language querying of agricultural product data . The system architecture follows a three-stage pipeline: query classification, context assembly, and LLM response generation, as illustrated in Figure~\ref{fig:rag-pipeline}.
...
\toprule
\rowcolor{headerblue}
\textcolor{white}{\textbf{Domain}} & \textcolor{white}{\textbf{Tables}} & \textcolor{white}{\textbf{Purpose}} \\
\midrule
User and Organization & users, app\_users, organizations & Authentication, roles, multi-tenancy \\
\rowcolor{rowalt}
agricultural product data & farmers, plots, observations, crop\_types, attachments & Core agricultural records \\
...
\toprule
\rowcolor{headerblue}
\textcolor{white}{\textbf{Category}} & \textcolor{white}{\textbf{Technology}} & \textcolor{white}{\textbf{Purpose}} \\
\midrule
...
\toprule
\rowcolor{headerblue}
\textcolor{white}{\textbf{Version}} & \textcolor{white}{\textbf{MAE (kg/ha)}} & \textcolor{white}{\textbf{RMSE (kg/ha)}} \\
\midrule
...
Figure~\ref{fig:prediction-interface} shows the prediction and analysis interface of the agricultural product data Platform. Users can select crop type, region, season, and input environmental parameters such as rainfall and temperature to receive instant yield predictions. The interface presents results alongside historical trends, enabling stakeholders to compare predicted yields against past performance for the same crop-region combination.

\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{prediction-and-analysis.png}
\caption{Prediction and Analysis Interface}
\label{fig:prediction-interface}
\end{figure}

The prediction interface was evaluated through usability testing with five end users including two field agents, one government agricultural officer, one NGO program manager, and one researcher. All five users successfully completed a prediction task without assistance. The average time from parameter entry to result display was under three seconds, confirming that the ML microservice integration provides a responsive user experience. Users noted that the ability to compare predicted yields with historical data for the same region and crop was particularly valuable for planning purposes.
...
\toprule
\rowcolor{headerblue}
\textcolor{white}{\textbf{Type}} & \textcolor{white}{\textbf{Keywords}} & \textcolor{white}{\textbf{SQL Target}} & \textcolor{white}{\textbf{Example}} \\
\midrule
...
\rowcolor{rowalt}
Region & region, zone, area, woreda & multi-table & "agricultural product data for Tigray" \\
\bottomrule
\end{tabularx}
\end{table}
...
Figure~\ref{fig:smart-query} shows the Smart Query Bot interface integrated into the platform. Users can type natural language questions about agricultural product data and receive structured, grounded responses powered by the RAG pipeline. The chat interface maintains conversation context, allowing users to ask follow-up questions without restating their original query parameters.

\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{smart-query-bot.png}
\caption{Smart Query Bot Interface}
\label{fig:smart-query}
\end{figure}

The Smart Query Bot was tested across all six query categories with 30 representative questions. For yield queries, the system achieved 95 percent accuracy in generating correct SQL aggregations. For farmer queries, the system correctly filtered by region and crop type in 90 percent of cases. The most common failure mode was ambiguous queries where the user did not specify a region, leading to overly broad results. When the primary LLM provider (OpenRouter) experienced downtime during testing, the system seamlessly fell back to Cerebras without any user-visible degradation in response quality, confirming the resilience of the three-tier fallback architecture. The average end-to-end response time from query submission to answer display was approximately 4.5 seconds, with the LLM generation step accounting for roughly 70 percent of the total latency.
...
Figure~\ref{fig:dashboard} presents the main dashboard interface of the agricultural product data Platform. The dashboard provides a unified overview of agricultural product data with role-based filtering, displaying key metrics including total farmer counts, yield summaries by crop type, and sync queue status. Interactive charts and maps enable stakeholders to explore data patterns geographically and temporally.

\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{dashboard.png}
\caption{agricultural product data Platform Dashboard}
\label{fig:dashboard}
\end{figure}

The dashboard was tested across all seven user roles to verify that role-based data filtering functions correctly. Admin users see aggregate data across all organizations and regions, while field agents see only their own submitted records. Traders receive yield and production summaries without individual farmer identifiers, preserving data privacy while enabling market intelligence. Government and NGO users receive regional and crop-level analytics relevant to their oversight mandates. The dashboard loads within two seconds on a standard broadband connection, with the Leaflet.js map tiles loading progressively to maintain perceived responsiveness. The Recharts visualizations render client-side, reducing server load and enabling interactive data exploration including hover tooltips, zoom, and filter operations without additional API calls.
...
Figure~\ref{fig:data-import} shows the data import interface of the platform. Users can upload CSV or Excel files through a drag-and-drop interface that provides immediate feedback on detected columns, matched canonical fields, and any unrecognized columns requiring manual mapping.

\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{data-import.png}
\caption{Data Import Interface with Schema Detection}
\label{fig:data-import}
\end{figure}

The import interface guides users through a three-step workflow: file upload, column mapping review, and import confirmation. During the column mapping step, the system displays each detected column alongside its matched canonical field and a confidence indicator. Columns that match known aliases automatically, columns that require manual selection from a dropdown of canonical fields, and unrecognized columns that can be excluded from the import are all clearly distinguished. This approach accommodates the wide variety of column naming conventions found in legacy agricultural product data sets across Ethiopian cooperatives and government agencies.

The import module was stress-tested with files containing up to 10,000 rows. Processing times remained under five seconds for files under 5,000 rows and under fifteen seconds for the largest test files. The system correctly handled common data quality issues including missing values, inconsistent date formats, duplicate records, and columns with mixed data types. Invalid rows were quarantined with detailed error messages rather than causing the entire import to fail, enabling users to correct specific records and re-upload without losing previously validated data.
...
\toprule
\rowcolor{headerblue}
\textcolor{white}{\textbf{Canonical Field}} & \textcolor{white}{\textbf{Recognized Aliases}} \\
\midrule
...
The stakeholder dashboard system addresses a gap in existing agricultural product data platforms by implementing role-based data filtering informed by the Technology Acceptance Model \cite{davis1989}, ensuring each user type sees information relevant to their specific tasks.
...
\section{Conclusion}
This thesis successfully developed, implemented, and validated a comprehensive agricultural product data Platform addressing the critical challenge of information asymmetry in Ethiopian agriculture. The five functional modules -- offline synchronization, legacy data import, machine learning yield prediction, RAG-based querying, and stakeholder-specific dashboards -- collectively constitute a meaningful technical contribution to precision agriculture in resource-constrained environments. The system's modular architecture, comprehensive API surface of 108 endpoints, 15-table database schema, and multi-layered security design provide a robust foundation for agricultural product data management.
...
The project directly supports Ethiopia's Digital Agriculture strategy as articulated in the Digital Ethiopia 2025 initiative \cite{digitalethiopia2025} and provides a reusable architectural blueprint for similar agricultural product data systems across Sub-Saharan Africa.

\section{Summary of Contributions}
The specific contributions of this project are as follows:

\begin{enumerate}
  \item A modular three-tier system architecture combining AdonisJS 7, Next.js 16, FastAPI, and PostgreSQL 15 as a reference implementation for agricultural product data systems.
  ...
  \item A SQL-based RAG implementation for structured agricultural product data , demonstrating grounded natural language querying without vector similarity search.
...
The agricultural product data Platform demonstrates that it is possible to build comprehensive, accessible, and useful agricultural product data platforms even in resource-constrained environments with limited internet connectivity. The project's modular architecture, 108-endpoint API, 15-table database schema, and focus on user accessibility through role-based interfaces and natural language querying ensure it can serve as a foundation for continued development and deployment. As Ethiopia pursues its Digital Ethiopia 2025 strategy, systems like ADP will play an increasingly important role in enabling data-driven decision-making, improving agricultural productivity, and enhancing food security for millions of smallholder farmers.
...
\renewcommand{\arraystretch}{1.4}
\begin{tabularx}{\textwidth}{*{4}{>{\raggedright\arraybackslash}X}*{5}{>{\raggedleft\arraybackslash}X}}
\toprule
\rowcolor{headerblue}
\textcolor{white}{\textbf{Crop}} & \textcolor{white}{\textbf{Season}} & \textcolor{white}{\textbf{Region}} & \textcolor{white}{\textbf{Year}} & \textcolor{white}{\textbf{Area}} & \textcolor{white}{\textbf{Rain}} & \textcolor{white}{\textbf{Temp}} & \textcolor{white}{\textbf{Fert}} & \textcolor{white}{\textbf{Yield}} \\
\midrule

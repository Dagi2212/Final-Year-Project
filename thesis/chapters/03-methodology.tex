...
\begin{itemize}
  ...
  \item Natural language querying of agricultural data
...
The database schema was designed with 15 tables organized into six domains: user management, organizations, entity tracking, agricultural data, data management, analytics, and system operations. Database views were designed for dashboard aggregation queries to optimize read performance.
...
The data collection process involved sourcing a comprehensive dataset of crop yield records representative of Ethiopian agricultural conditions. The training dataset was compiled from publicly available agricultural data sources covering Ethiopian crop production across major regions and crop types.
...
The Integrated Agricultural Data System follows a modular, three-tier architecture with clear separation of concerns between the presentation layer, application logic layer, and data persistence layer.
...
The backend implements resource-oriented RESTful controllers for all agricultural data entities:
...
\subsubsection{Agricultural Data Domain}
\begin{itemize}
...
\begin{itemize}
  ...
  \item \textbf{imported\_records:} Individual imported records with all agricultural data fields
\end{itemize}
